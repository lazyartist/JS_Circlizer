...
export class CollisionComponent extends ComponentBase {
    ...
    getWorldRect() {
        ...
        let rect: CommonModule.Rect = new CommonModule.Rect(x1, y1, this.size.x, this.size.y);
    ...
    notifyCollision(inOtherActor, collisionResult: CollisionResult) {
